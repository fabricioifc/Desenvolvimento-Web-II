...
\begin{frame}
	...
	{\small
		...
		\begin{block}{Experimento 3}
			\begin{itemize}
				\item Criar uma API REST que faça autenticacão com JWT. A API deve ter endpoints para
				      login, registro e acesso a recursos protegidos. Disponibilize a documentação
				      mínima dos endpoints (por exemplo, usando o Swagger).
				...
				\item Use cookies ou LocalStorage para armazenar o token JWT no cliente.
				      Opcionalmente, implemente a renovação do token JWT.
