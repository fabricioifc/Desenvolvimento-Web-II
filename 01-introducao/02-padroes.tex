...
\subtitle{Aula 02 - Padrões de Projeto} % Presentation subtitle, remove this command if a subtitle isn't required
...
\begin{frame}
	...
	\begin{block}{Observações}
		\begin{itemize}
			\item O experimento 02 deve ser publicados no \textbf{GitHub}. No arquivo \textbf{README.md}, explique resumidamente o que foi feito e como foi feito.
