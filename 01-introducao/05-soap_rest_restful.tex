...
\begin{frame}
	...
	\begin{block}{16. Swagger}
		\begin{itemize}
			...
			\item O Swagger permite que você gera automaticamente o código do cliente em várias linguagens de programação.
		\end{itemize}
	\end{block}

	\begin{exampleblock}{Exemplo}
		% \includegraphics[width=0.9\linewidth]{swagger_example.png}
	\end{exampleblock}
