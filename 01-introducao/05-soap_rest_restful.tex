...
\begin{frame}
	...
	\begin{block}{1. Documentação Clara}
		Forneça uma documentação clara e abrangente para a API, descrevendo recursos, endpoints, parâmetros, cabeçalhos e exemplos de solicitações e respostas. Existem bibliotecas que podem ajudar a gerar a documentação automaticamente.
	\end{block}
