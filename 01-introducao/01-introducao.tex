...
\begin{frame}
	...
	Abordagem tradicional no desenvolvimento de software na qual todos os componentes de uma aplicação são combinados em uma única unidade totalmente integrada. A aplicação é implantada como uma \alert{única e grande base de código} que contém todas as funcionalidades.

	\begin{figure}
		\centering
		\includegraphics[width=0.6\linewidth]{Images/monolito.jpg}
