...
\begin{frame}
	...
	\begin{block}{Web Moderna}
		A arquitetura moderna da Web enfatiza a \alert{escalabilidade} das interações entre componentes, a \alert{generalidade} das interfaces, a implantação \alert{independente} de componentes e a presença de componentes intermediários para reduzir a latência da interação, reforçar a segurança e encapsular sistemas legados \parencite{tese2023}.
	\end{block}
