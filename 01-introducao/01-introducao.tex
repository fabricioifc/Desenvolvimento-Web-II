...
\begin{frame}
	...
	\framesubtitle{Práticas e Exercícios}

	Você precisa criar uma aplicação web para calcular o IMC (Índice de Massa Corporal) de uma pessoa. A aplicação deve permitir que o usuário informe o peso e a altura e, em seguida, exibir o resultado do cálculo. Para fazer isso, você pode escolher entre as seguintes abordagens arquiteturais:

	\bigskip

	\begin{itemize}
		\item \textbf{Arquitetura 01}: \textit{Criar um simples projeto monolítico.}
		\item \textbf{Arquitetura 02}: \textit{Criar um simples projeto em camadas.}
		\item \textbf{Arquitetura 03}: \textit{Criar um simples projeto de microsserviços.}
		\item \textbf{Arquitetura 04}: \textit{Criar um simples projeto orientado a eventos.}
		\item \textbf{Arquitetura 05}: \textit{Criar um simples projeto serverless.}
		\item \textbf{Arquitetura 06}: \textit{Criar um simples projeto orientado a serviços.}
		\item \textbf{Arquitetura 07}: \textit{Criar um simples projeto monorepo.}
		\item \textbf{Arquitetura 08}: \textit{Criar um simples projeto multi-repo.}
	\end{itemize}
