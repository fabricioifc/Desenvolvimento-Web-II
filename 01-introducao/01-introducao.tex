...
\begin{frame}
	...
	\begin{exampleblock}{Características}
		\begin{itemize}
			...
			\item \textbf{Escalabilidade vertical:}: adicionar mais recursos a um componente (CPU, memória, etc).
		\end{itemize}
	\end{exampleblock}
...
\begin{frame}
	\frametitle{Principais Arquiteturas de Software}
	\framesubtitle{Monolito + N camadas}

	\begin{alertblock}{Monolito + N camadas}
		\begin{itemize}
			\item \textbf{Monolito + Camadas}: Uma aplicação monolítica pode ser estruturada em camadas. Por exemplo, um sistema tradicional MVC (Model-View-Controller) é monolítico e organizado em camadas.
			\item \textbf{Arquitetura em Camadas != Monolítica}: A arquitetura em camadas é um padrão de design, enquanto "monolítica" é um estilo arquitetural.
		\end{itemize}
	\end{alertblock}
...
\begin{frame}
	...
	\begin{alertblock}{Desvantagens}
		\begin{itemize}
			...
			\item \textbf{Testes}: Testes unitários e de integração podem ser mais complexos devido à natureza distribuída do sistema.
		\end{itemize}
	\end{alertblock}
