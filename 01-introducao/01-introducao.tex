...
\begin{frame}
	...
	\begin{block}{Web Moderna}
		A arquitetura moderna da Web enfatiza a escalabilidade das interações entre componentes, a generalidade das interfaces, a implantação independente de componentes e a presença de componentes intermediários para reduzir a latência da interação, reforçar a segurança e encapsular sistemas legados.
	\end{block}
