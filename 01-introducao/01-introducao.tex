...
\begin{frame}
	...
	A \alert{arquitetura de aplicações web} descreve a estrutura interna e interações entre seus componentes. A arquitetura de uma aplicação web é composta por:

	\begin{itemize}
		\item \textbf{Componentes}: partes que compõem a aplicação web. Exemplos: cliente, servidor, banco de dados, etc.
...
\begin{frame}
	\frametitle{Principais Arquiteturas de Aplicações Web}
...
\begin{frame}
	...
	\begin{alertblock}{Desvantagens}
		\begin{itemize}
			...
			\item \textbf{Comunicação entre camadas}: A comunicação entre camadas pode resultar em algum overhead, especialmente em sistemas distribuídos, o que pode impactar o desempenho.
			...
			\item \textbf{Aumento da Latência}: O acesso a dados através de várias camadas pode aumentar a latência.
		\end{itemize}
	\end{alertblock}
...
\begin{frame}
	...
	\begin{exampleblock}{Vantagens}
		\begin{itemize}
			...
			\item \textbf{Aplicabilidade}: em aplicações de grande porte e complexas que precisam ser escaladas rapidamente ou em organizações com equipes distribuídas.
		\end{itemize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\includegraphics[width=0.8\linewidth]{Images/mono_x_micro.png}
